...
func (tx *Transaction) EncodeRLP(w io.Writer) error {
	...
	if tx.Input0 != nil {
		...
		itf.OutIdx0 = NewUint256(tx.Input0.OutIdx)
	...
	if tx.Input1 != nil {
		itf.BlkNum1 = NewUint256(tx.Input1.BlkNum)
		itf.TxIdx1  = NewUint256(tx.Input1.TxIdx)
		itf.OutIdx1 = NewUint256(tx.Input1.OutIdx)
